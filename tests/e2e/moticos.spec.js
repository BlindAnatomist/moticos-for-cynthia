...
async function dragTile(page, from, to, nearMiss = false) {
  ...
  // Long routes and control taps can leave the board outside the viewport.
  // Reposition it immediately without Playwright waiting for every animated
  // descendant to become stable, then measure after two rendered frames.
  await page.evaluate(() => {
